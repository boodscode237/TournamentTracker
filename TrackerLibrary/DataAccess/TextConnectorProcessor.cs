    ...
    public static class TextConnectorProcessor
    {
            ...
            string prizeFileName)
        {
            ...
            List<MatchupModel> matchups = GlobalConfig.MatchupFile.FullFilePath()
                .LoadFile().ConvertToMatchupModels();
        ...
        private static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(
            string input)
        {
        ...
        {
            List<string> teams = GlobalConfig.TeamFile
                .FullFilePath().LoadFile();
            ...
            this List<string> lines)
        {
            ...
            string matchupFile, string matchupEntryFile)
        {
