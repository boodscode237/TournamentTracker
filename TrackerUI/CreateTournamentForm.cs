...
namespace TrackerUI
{
    public partial class CreateTournamentForm : Form, IPrizeRequester, ITeamRequester
    {
        ...
        {
            // Call the create prize form: .Show() allows the form to popup
        ...
        {
            PrizeModel p = (PrizeModel)prizezListBox.SelectedItem;
        ...
        private void createTounamentButton_Click(object sender, EventArgs e)
        {
            //validate Data
            decimal fee = 0;
            ...
            // Create  our tournament matchups
